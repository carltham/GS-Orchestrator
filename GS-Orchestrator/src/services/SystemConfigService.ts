...
export interface OrchestratorErrorMessages {
...
export interface OrchestratorConfig {
  ...
  errorMessages: OrchestratorErrorMessages;
}
...
export class SystemConfigService {
  ...
  private loadConfig(): OrchestratorConfig {
    ...
    // Default fallback if file is not found
    return {
  ...
  public getRules(): OrchestratorRules {
    return this.config.rules;
  }

  public formatError(key: keyof OrchestratorErrorMessages, params: Record<string, string> = {}): string {
